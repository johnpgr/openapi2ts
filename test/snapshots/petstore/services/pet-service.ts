...
export class PetService extends CommonHttpService {
    ...
    deletePet = async ({ petId, apiKey }: { petId: number; apiKey?: string }): Promise<void> => {
        return this.getClientInstance()
            .request({
                path: "/pet/{petId}",
                method: "DELETE",
    ...
    > => {
        return this.getClientInstance()
            .request({ path: "/pet/findByStatus", method: "GET", query: { status } })
            .then(
    ...
    > => {
        return this.getClientInstance()
            .request({ path: "/pet/findByTags", method: "GET", query: { tags } })
            .then(
                this.getClientInstance().responseHandler({
                    200: { "application/xml": "blob", "application/json": "json" },
                }),
    ...
    > => {
        return this.getClientInstance()
            .request({ path: "/pet/{petId}", method: "GET", pathParams: { petId } })
            .then(
                this.getClientInstance().responseHandler({
                    200: { "application/xml": "blob", "application/json": "json" },
                }),
