import type { OpenApiSchema } from './common.ts';
import type { OpenApiDocument, OpenApiHttpMethod, OpenApiOperation, OpenApiPathItem } from './openapi.ts';
import type { CommonOpenApiClientGeneratorConfigDocumentPatch } from '../schema-to-typescript/config.ts';
import type { JsonObject, JsonValue } from '../utils/json-value.ts';
